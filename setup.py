...
setup(
    ...
    install_requires=['numpy', 'scipy', 'PySide' if not (sys.version_info.major == 3 and sys.version_info.minor == 5) else '', 'pyopengl', 'pyqtgraph', 'matplotlib==1.4.3' if sys.version_info.major == 3 and sys.version_info.minor < 4 else 'matplotlib'],
    license="BSD",
