...
htmlhelp_basename = 'pyunlocboxdoc'
...
latex_documents = [
  ('index', 'pyunlocbox.tex', u'pyunlocbox Documentation',
   u'EPFL LTS2', 'manual'),
]
...
man_pages = [
    ('index', 'pyunlocbox', u'pyunlocbox Documentation',
     [u'EPFL LTS2'], 1)
]
...
texinfo_documents = [
  ('index', 'pyunlocbox', u'pyunlocbox Documentation',
   u'EPFL LTS2', 'pyunlocbox', 'One line description of project.',
   'Miscellaneous'),
]
